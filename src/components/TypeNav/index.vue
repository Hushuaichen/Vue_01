                           ...
                           >
                            <h3>
                                ...
                                <!-- <router-link :to="{
                                    ...
                                    query:{
                                        category1Id:c1.categoryId,
                                        categoryName:c1.categoryName}})">{{c1.categoryName}}</a> -->
                            </h3>
                            ...
                            <a href="javascript:;" :data-category2Id="c2.categoryId"  :data-categoryName="c2.categoryName">{{c2.categoryName}}</a>
                                ...
                                <!-- <router-link :to="{
                                    name:'search',
                                    query:{category2Id:c2.categoryId,categoryName:c2.categoryName}
                                    }">{{c2.categoryName}}</router-link> -->
                                            <!-- <a href="javascript:;" @click="$router.push({
                                    name:'search',
                                    query:{
                                        category2Id:c2.categoryId,
                                        categoryName:c2.categoryName}})">{{c2.categoryName}}</a> -->
                                        </dt>
                                        <dd>
                                ...
                                <a href="javascript:;" :data-category3Id="c3.categoryId"  :data-categoryName="c3.categoryName">{{c3.categoryName}}</a>
                                    ...
                                    query:{
                                        category3Id:c3.categoryId,
                                        categoryName:c3.categoryName}})">{{c3.categoryName}}</a> -->
                                            </em>
                                        </dd>
                                    </dl>
                                </div>
...
export default {
    ...
    //从vuex中拿数据到vue组件中
    computed:{  //从vuex中拿数据(state和getters中的东西)都在computed中    拿方法(mutations和actions中的东西)在methods中
        ...mapState({
